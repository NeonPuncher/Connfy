...
<html>
    <head>
        ...
        <link rel="stylesheet" href="mediastyle.css" type="text/css">
    ...
    <body onload="LoadDivs()">
        <div class="header">
            <header>
              <img class="arrow" src="Icons/Arrow-left.png"> 
              <div class="line"></div>
            </header>
        </div>
        <canvas id="canvas" class="canvas"></canvas>
        <div class="overlay" id="overlay">
            <div class="overlayHeader"><h2 align="center">Folder 1:</h2></div>
            <div class="folderContent">
                ...
                <img src="Icons/FeatureMatrix.png" style="width: 100%;">
        ...
        <div id="div6" class="folder" onclick="folderActive()">
            <img src="Icons/FolderIcon.png" class="folderIcon">
            <h3>Folder</h3>
        </div>
        <div id="mydivheader" class="note"><h3>Marked Text:</h3></div>

        <img src="Icons/NoteIcon.png" class="Icon" onclick="createNote() ,LoadDivs()">
        <img src="Icons/DrawIcon.png" class="Icon" id="drawIcon" onclick="activateDraw()">
